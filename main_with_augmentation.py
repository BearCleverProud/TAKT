...
from utils.core_utils import train_with_augmentation
...
def main(args):
    ...
    for i in folds:
        ...
        results, test_auc, val_auc, test_acc, val_acc, test_f1, val_f1, test_recall, val_recall, test_precision, val_precision = train_with_augmentation(datasets, i, args)
...
parser.add_argument('--aug_dataset', type=str)
